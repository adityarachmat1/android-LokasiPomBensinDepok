...
public class Pom9 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom9);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map9);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom17 = new LatLng(-6.378042, 106.813586);
        MarkerOptions markerpomdepok17 = new MarkerOptions();
		markerpomdepok17.position(pom17);
        markerpomdepok17.title("SPBU 34.164.12");
        markerpomdepok17.snippet("Jl. H Asmawi Beji Depok, Jawa Barat");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.378042, 106.813586),12));
