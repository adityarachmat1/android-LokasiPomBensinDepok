...
public class Pom19 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom19);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map19);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom3 = new LatLng(-6.4086492, 106.7574073);
        MarkerOptions markerpomdepok3 = new MarkerOptions();
		markerpomdepok3.position(pom3);
        markerpomdepok3.title("SPBU 34.165.09");
        markerpomdepok3.snippet("Jl.raya Muhtar Depok, Jawa Barat");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.4086492, 106.7574073),12));
