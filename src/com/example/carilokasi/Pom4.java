...
public class Pom4 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom4);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map4);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom13 = new LatLng(-6.399143, 106.821785);
        MarkerOptions markerpomdepok13 = new MarkerOptions();
		markerpomdepok13.position(pom13);
        markerpomdepok13.title("SPBU 34.164.04");
        markerpomdepok13.snippet("Jl. Raya Siliwanggi Depok Depok, Jawa Barat");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.399143, 106.821785),12));
