...
public class Pom21 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom21);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map21);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom23 = new LatLng(-6.366604, 106.775045);
        MarkerOptions markerpomdepok23 = new MarkerOptions();
		markerpomdepok23.position(pom23);
        markerpomdepok23.title("SPBU 34.165.12");
        markerpomdepok23.snippet(" Jl. Raya Limo No.36, Limo Depok, Jawa Barat");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.366604, 106.775045),12));
