...
public class Pom13 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom13);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map13);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom5 = new LatLng(-6.4246737,106.7620091);
        MarkerOptions markerpomdepok5 = new MarkerOptions();
		markerpomdepok5.position(pom5);
        markerpomdepok5.title("SPBU 34.164.17");
        markerpomdepok5.snippet("Pd. Cina,Beji,Kota Depok, Jawa Barat 16424,Indonesia");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.4246737,106.7620091),12));
