...
public class Pom14 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom14);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map14);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom28 = new LatLng(-6.4388718,106.7972593);
        MarkerOptions markerpomdepok28 = new MarkerOptions();
		markerpomdepok28.position(pom28);
        markerpomdepok28.title("SPBU 34.164.20");
        markerpomdepok28.snippet("Jl. Raya Cipayung,Jawa Barat,Indonesia");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.4388718,106.7972593),12));
