...
public class Pom8 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom8);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map8);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom16 = new LatLng(-6.4002213,106.7888713);
        MarkerOptions markerpomdepok16 = new MarkerOptions();
		markerpomdepok16.position(pom16);
        markerpomdepok16.title("SPBU 34.164.11");
        markerpomdepok16.snippet("Jl. Raya Kartini,Pancoran MAS,Kota Depok, Jawa Barat 16431,Indonesia");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.4002213,106.7888713),12));
