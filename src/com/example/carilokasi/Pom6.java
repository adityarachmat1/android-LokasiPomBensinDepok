...
public class Pom6 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom6);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map6);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom27 = new LatLng(-6.4320451,106.8012366);
        MarkerOptions markerpomdepok27 = new MarkerOptions();
		markerpomdepok27.position(pom27);
        markerpomdepok27.title("SPBU 34.164.08");
        markerpomdepok27.snippet("Jl. Raya Citayam,Cipayung,Kota Depok, Jawa Barat 16431,Indonesia");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.4320451,106.8012366),12));
