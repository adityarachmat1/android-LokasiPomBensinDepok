...
public class Pom27 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom27);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map27);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom11 = new LatLng(-6.3628608, 106.9064995);
        MarkerOptions markerpomdepok11 = new MarkerOptions();
		markerpomdepok11.position(pom11);
        markerpomdepok11.title("SPBU 34.169.32");
        markerpomdepok11.snippet("Jl.Harjamukti Depok, Jawa Barat");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.3628608, 106.9064995),12));
