...
public class Pom18 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom18);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map18);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom30 = new LatLng(-6.3520204,106.7689729);
        MarkerOptions markerpomdepok30 = new MarkerOptions();
		markerpomdepok30.position(pom30);
        markerpomdepok30.title("SPBU 34.165.08");
        markerpomdepok30.snippet("Jl. Raya Gandul,Cinere,Kota Depok, Jawa Barat 16514,Indonesia");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.3520204,106.7689729),12));
