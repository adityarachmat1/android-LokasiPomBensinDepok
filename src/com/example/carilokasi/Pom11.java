...
public class Pom11 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom11);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map11);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom19 = new LatLng(-6.455789, 106.826203);
        MarkerOptions markerpomdepok19 = new MarkerOptions();
		markerpomdepok19.position(pom19);
        markerpomdepok19.title("SPBU 34.164.14");
        markerpomdepok19.snippet("Jl. Jati Mulya Kp.Sawah Depok, Jawa Barat");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.455789, 106.826203),12));
