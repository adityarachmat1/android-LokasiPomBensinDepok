...
public class Pom28 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom28);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map28);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom31 = new LatLng(-6.3705232,106.8590108);
        MarkerOptions markerpomdepok31 = new MarkerOptions();
		markerpomdepok31.position(pom31);
        markerpomdepok31.title("SPBU 34.169.51");
        markerpomdepok31.snippet("Jl.Tugu,Cimanggis, Kota Depok, Jawa Barat 16951, Indonesia");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.3705232,106.8590108),12));
