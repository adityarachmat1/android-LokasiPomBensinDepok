...
public class Pom10 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom10);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map10);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom18 = new LatLng(-6.4039743,106.7906738);
        MarkerOptions markerpomdepok18 = new MarkerOptions();
		markerpomdepok18.position(pom18);
        markerpomdepok18.title("SPBU 34.164.13");
        markerpomdepok18.snippet("Jl. Raya Pitara Pancoran Mas Depok, Jawa Barat");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.4039743,106.7906738),12));
