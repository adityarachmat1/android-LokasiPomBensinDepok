...
public class Pom3 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom3);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map3);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom32 = new LatLng(-6.3969922,106.7761177);
        MarkerOptions markerpomdepok32 = new MarkerOptions();
		markerpomdepok32.position(pom32);
        markerpomdepok32.title("SPBU 34.164.03");
        markerpomdepok32.snippet("Jl. Raya Sawangan,Pancoran MAS,Kota Depok, Jawa Barat 16435,Indonesia");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.3969922,106.7761177),12));
