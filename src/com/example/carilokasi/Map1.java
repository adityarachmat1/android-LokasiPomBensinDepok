...
private LatLng jakarta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LatLng pom1 = new LatLng(-6.337893, 106.780938);
        MarkerOptions markerpomdepok1 = new MarkerOptions();
		markerpomdepok1.position(pom1);
        markerpomdepok1.title("34.165.03");
        markerpomdepok1.snippet("Jl.cinere raya Depok, Jawa Barat");
        markerpomdepok1.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED));
