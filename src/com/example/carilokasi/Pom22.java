...
public class Pom22 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pom22);
        FragmentManager myFragmentManager = getSupportFragmentManager();
        SupportMapFragment mySupportMapFragment = (SupportMapFragment)myFragmentManager.findFragmentById(R.id.map22);
        myMap = mySupportMapFragment.getMap();
        
        LatLng pom35 = new LatLng(-6.3866161,106.8669695);
        MarkerOptions markerpomdepok35 = new MarkerOptions();
		markerpomdepok35.position(pom35);
        markerpomdepok35.title("SPBU 34.169.09");
        markerpomdepok35.snippet("Jl. Raya Jak - Bogor,Cimanggis,Kota Depok, Jawa Barat 16416,Indonesia");
        ...
        myMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-6.3866161,106.8669695),12));
